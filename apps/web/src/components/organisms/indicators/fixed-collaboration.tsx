...
export const FixedCollaboration = () => {
  ...
  return (
    <div className="hidden md:block fixed top-4 right-4 z-50 transform translate-y-12 bg-background border-2 border-black shadow-[2px_2px_0px_black] p-3">
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-xs font-bold">
            {count > 0 ? `+${count} online` : 'No users online'}
          </span>
        </div>
      </div>
    </div>
